...
filename: learnjulia-kr.julia
translators:
    - ["Jaesung Eom", "https://twitter.com/JaesungEom"]
lang: ko-kr
---

줄리아는 새로운 homoiconic 함수형 언어로 기술 계산에 초점을 맞추고 있습니다.
homoiconic 매크로들의 능력을 가지면서, 함수 우선, 그리고 저수준 콘트롤이 가능한, 줄리아는 파이썬을 배우고 쓰는 것 만큼 쉽습니다.
이 문서는 2013년 10월 18일, 현재 줄리아 개발 버전을 염두해 쓰여져 있습니다.
